...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_13_EEB //RAMPS 1.3 / 1.4 (Power outputs: Extruder0, Extruder1, Bed)
#endif
...
//    #define  DEFAULT_bedKi 0.8
//    #define  DEFAULT_bedKd 200.0
    #define  DEFAULT_bedKp 188.41
    #define  DEFAULT_bedKi 36.86
    #define  DEFAULT_bedKd 240.76
...
// default settings
// XY Motor Step Angle: 1.8 (200 per rev)
// Driver MicroStepping: 1/16 (Pololu A4988)
// Belt Pitch: 2 (GT-2 rubber w/fibreglass reinforcing)
// Pulley Tooth Count: 20 (GT-2) 
// Length=20*2 = 40mm/cycle
// Pulse= 360/1.8/(1/16)pulse/cycle
// Pulse/Length= 80.00 pulse/mm
// Resolution: 12.5 micron
// For Z
// Length 1.5mm/cycle
// 200*16/1.5=2133.333 pulse/mm


// #define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2133.333,99.275}  // default steps per unit for Ultimaker by Aynik measured
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200,200,8000,2814.344}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 4, 40}    // (mm/sec)
